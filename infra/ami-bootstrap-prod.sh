#!/bin/bash
#
# PROD EC2 user-data bootstrap for an ARM64 (Graviton, c7g.xlarge) transcode worker.
# SSM prefix is hardcoded to /euron-vod-prod. The dev copy is ami-bootstrap-dev.sh.
# Keep the two files in sync except for this prefix line and the header.
#
...
SSM_PREFIX=/euron-vod-prod    # PROD. Params are named /euron-vod-prod/<NAME>.
